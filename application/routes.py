...
def update():
  ...
  if search.validate_on_submit():
    ...
    if hero.validate_on_submit():
      result.publisher=hero.publisher.data.upper()
      result.name=hero.name.data.upper()
      result.alterego=hero.alterego.data.upper()
      result.p1=hero.p1.data.upper()
      result.p2=hero.p2.data.upper()
      result.p3=hero.p3.data.upper()
      result.team=hero.team.data.upper()
      result.sidekick=hero.sidekick.data.upper()
      result.nemesis=hero.nemesis.data.upper()
      db.session.commit()
